<%@ Page Language="C#" MasterPageFile="~/PracticaMaD.Master"
    AutoEventWireup="true" CodeBehind="UpdateUserProfile.aspx.cs" Inherits="Es.Udc.DotNet.PracticaMaD.WebApplication.Pages.User.UpdateUserProfile" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <div id="form">
        <form id="UpdateUserProfileForm" method="POST" runat="server">
            <asp:HyperLink ID="lnkChangePassword" runat="server" 
                ...
                meta:resourcekey="lnkChangePassword">[lnkChangePassword]</asp:HyperLink>
            <div class="field">
            ...
            <div class="field">
                <span class="label"><asp:Localize ID="lclEmail" runat="server" meta:resourcekey="lclEmail" /></span><span class="entry">
                    ...
                    <asp:RegularExpressionValidator ID="revEmail" runat="server"
                        ControlToValidate="txtEmail" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" meta:resourcekey="revEmail"></asp:RegularExpressionValidator>
                     <asp:Label ID="lblEmailError" runat="server" ForeColor="Red" Style="position: relative"
                            Visible="False" meta:resourcekey="lblEmailError"></asp:Label>
                                                                                                                    </span>
            </div>

            <div class="field">
                <span class="label"><asp:Localize ID="lclPostalAddress" runat="server" meta:resourcekey="lclPostalAdress" /></span><span class="entry">
                    ...
                    <asp:RequiredFieldValidator ID="tfvPostalAddress" runat="server"
                        ControlToValidate="txtPostalAddress" Display="Dynamic" Text="<%$ Resources:Common, mandatoryField %>" meta:resourcekey="tfvPostalAddressResource1"/>
                     <asp:CompareValidator ID="cvPostalAddress" runat="server" ControlToValidate="txtPostalAddress" Type="Integer"
                         Operator="DataTypeCheck" ErrorMessage="<%$ Resources:Common, integerField %>" />
                   </span></div>
